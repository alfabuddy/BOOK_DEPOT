...
import bannerImage from "/public/bn1.png";
function Banner() {
  return (
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10 bg-transparent">
      ...
      <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-36">
        <div className="space-y-8">
          ...
          <label className="flex items-center gap-2 border border-gray-300 p-2 rounded-md">
            <svg
            ...
            <input type="text" className="grow bg-transparent focus:outline-none" placeholder="Email" />
          </label>
        </div>
